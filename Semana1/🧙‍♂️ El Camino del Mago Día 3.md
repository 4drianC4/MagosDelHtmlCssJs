...
```
    Ventaja: Mantienes el orden. Un solo archivo de estilos puede controlar 100 páginas HTML.
...
<p style="color: red;">Texto</p>
    ...
    Desventaja: Es una pesadilla de mantener. ¡Evítala a menos que sea estrictamente necesario!
...
Esta caja tiene 4 capas, desde adentro hacia afuera:
    ...
    Content (Contenido): El texto o la imagen real.

    Padding (Relleno): El espacio interno entre el contenido y el borde. Es como el plástico de burbujas dentro de una caja.

    Border (Borde): La línea que rodea la caja.

    Margin (Margen): El espacio externo que separa esta caja de las demás. Es el "espacio personal" del elemento.
